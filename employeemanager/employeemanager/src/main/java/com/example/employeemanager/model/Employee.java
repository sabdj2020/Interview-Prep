...
//Serializable helps to transform class Employee into different type of stream(because this class will be saved to db and sent to Front end as a Json format)
...
public class Employee implements Serializable {
	...
	//Lambock to generate constructors and getter, setter, toString
